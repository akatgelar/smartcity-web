                ...
                <div class="overflow-hidden pt-4 pb-4 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        ...
                        <div class="mt-5 flex flex-col justify-end gap-5 xl:flex-row xl:items-center">
                            <a href="/admin/user-level" class="w-40 border border-gray-300 shadow-theme-xs hover:bg-gray-100 inline-flex items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-black transition">
...
const postData = async () => {
    ...
    axios.put(`/api/user_level/${route.params.id}`, formJson,
        {headers: {'Authorization': `Bearer ${getSession().token}`}}
    )
    .then(response => {
        Swal.close()
