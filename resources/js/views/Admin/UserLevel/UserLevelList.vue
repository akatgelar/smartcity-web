        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex flex-col justify-between gap-5 border-gray-200 px-5 py-4 sm:flex-row sm:items-center dark:border-gray-800">
                ...
                <div class="flex gap-3">
                    <router-link to="/admin/user-level/add" class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-white transition">
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-white/[0.5]" v-for="item in items" :key="item.id">
                                    ...
                                    <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05] text-center">
                                        <router-link :to="`/admin/user-level/detail/${item.id}`" class="shadow-theme-xs inline-flex h-8 w-10 items-center justify-center rounded-lg border border-gray-300 text-blue-light-500 hover:text-blue-light-700 dark:text-blue-light-400 dark:hover:text-blue-light/90 mr-2">
                                        ...
                                        <router-link :to="`/admin/user-level/edit/${item.id}`" class="shadow-theme-xs inline-flex h-8 w-10 items-center justify-center rounded-lg border border-gray-300 text-yellow-500 hover:text-yellow-700 dark:text-yellow-400 dark:hover:text-yellow/90  mr-2">
...
const fetchData = async () => {
    ...
    axios.get(`/api/user_level?per_page=${perPage.value}&page=${page.value}&sort=${sortBy.value}:${sortOrder.value}&search=${search.value}`,
